...
class Product(models.Model):
    ...
    description = models.TextField(verbose_name='Описание', **NULLABLE,)
    image = models.ImageField(upload_to='catalog/product', verbose_name='Изображение', **NULLABLE,)
    category = models.ForeignKey(Category, on_delete=models.CASCADE, verbose_name="Категория", related_name='product',)
    price = models.PositiveIntegerField(verbose_name='Цена',)
    created_at = models.DateTimeField(null=True, verbose_name="Дата создания", auto_now_add=True,)
    updated_at = models.DateTimeField(null=True, verbose_name="Дата последнего изменения", auto_now=True,)
